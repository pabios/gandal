            ...
            <div class="table-responsive">
                ...
                <?php
                    ...
                    foreach($posts as $post):
                         $datePost = ucfirst(strftime('%A,le %d',strtotime($post['published_at'])));
                        $datePost .=ucfirst(strftime('%B %Y',strtotime($post['published_at'])));
                    ?>
                    <form action="" method="post">
                        <tr>
                            ...
                            <td > <input readonly class="form-control-plaintext" type ="text" name ="maDate" value=" <?=$datePost?>"/></td>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.6/umd/popper.min.js" integrity="sha384-wHAiFfRlMFy6i5SRaxvfOCifBUQy1xHdJ/yoi7FRNXMRBu5WHdZYu1hA6ZOblgut" crossorigin="anonymous"></script>
    ...
    <script>
      ...
      function recharge(){
        $('#divRecharge').load('./user-admin.php');
      }
    </script>
